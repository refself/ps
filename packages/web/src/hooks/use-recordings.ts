...
import { listRecordings, getRecordingDetail, type WorkflowRecording, type RecordingDetailResponse } from '../services/recording-api';
...
export const useRecordings = (workflowId: string | null) => {
  ...
  const getRecording = useCallback(async (recordingId: string): Promise<RecordingDetailResponse | null> => {
